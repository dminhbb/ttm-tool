...
export default function DomainsAdminPage() {
  ...
  const filteredDomains = domains.filter((domain) => fuzzyIncludes(searchTerm, [domain.domainCode, domain.domainName, domain.leadName, domain.description, domain.isActive ? 'active' : 'inactive']));
