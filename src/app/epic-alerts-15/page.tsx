                  ...
                  <TR key={row.epicKey} className={row.hasDataAnomaly ? 'missing-row' : undefined}>
                    ...
                    <TD>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 4, alignItems: 'flex-start' }}>
                        ...
                        {/* "Sai lệch dữ liệu" is informational (missing Requirement Level, T0, …) —
                            shown alongside the alert badges above, never hiding them (see
                            breaksTtmCnttCalculation/breaksTtmE2eCalculation in epic-data-anomaly.ts). */}
