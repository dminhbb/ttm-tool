...
export async function POST(request: NextRequest) {
  try {
    ...
    await createManagedUser({ email: body.email.trim().toLowerCase(), fullName: body.fullName.trim(), password: body.password, role: 'USER', isActive: false, domainIds: [body.domainId], projectIds: [], projectComponents: {} });
