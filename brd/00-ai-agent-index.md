...
| `06-master-data-management.md` | Domain, Project (import CSV), Holiday, Status Alert Rule, TTM config, DB Backup/Restore | Khi code menu Quản trị hệ thống |
| `07-data-source-and-csv-import.md` | Data Source Adapter, CSV import, quản lý lớp dữ liệu hàng ngày (Data Layer Logs) | Khi code nhập dữ liệu |
| `08-data-model.md` | Mô hình dữ liệu CSDL (RAW, Canonical, Snapshots, DB Dump) | Khi thiết kế DB, migration, ORM |
| `09-ui-ux-prototypes.md` | Danh sách prototype, định hướng UI & hệ thống mờ kính iOS Frosted Glass | Khi code giao diện |
