...
/brd
  ...
  11-mvp-roadmap.md
  12-ttm-policy-and-epic-alert-ui.md
  13-epic-15-and-epic-30-management.md
  14-issue-hierarchy-and-workflows.md
```
...
Source of truth: `brd/14-issue-hierarchy-and-workflows.md`.

- Cấp 1: `Epic`, `CTNB`; cấp 2: `Story`, `Task`, `Enabler Story`; toàn bộ Issue Type Jira khác là cấp 3, gọi chung là **Subtask**.
- Story dùng workflow 14 trạng thái riêng. Tất cả Subtask dùng chung workflow `To Do → In Progress → Done`, không phụ thuộc tên Issue Type Jira cụ thể.
- `Pending` và `Cancelled` là status đặc biệt, không thuộc thứ tự workflow và có thể xuất hiện tại mọi giai đoạn.
